...
bool lightOutput = LOW;   // Declare your output variabe
int pulseDuration = 200;  // Pulse duration in milliseconds
int numPulses = 0;
int pulseCount = 0;
...
void setup() {
  ...
  pinMode(32, OUTPUT);  //output for IDLE state
  pinMode(33, OUTPUT);  //output for SHORT
  pinMode(34, OUTPUT);  //output for LONG
}
...
void updateStateMachine() {
  ...
  switch (state) {
    case State::IDLE:
      ...
      digitalWrite(34, LOW);
      // numPulses = 1;
      // if (currentMillis - prevMillis >= pulseDuration) {
      //   prevMillis = currentMillis;
      //   if (pulseCount < numPulses * 2) {
      //     lightOutput = !lightOutput;
      //     digitalWrite(32, lightOutput);
      //   }
      //   pulseCount++;
      //   if (pulseCount >= numPulses * 2) {
      //     lightOutput = LOW;
      //     digitalWrite(32, lightOutput);
      //     // Finish the pulses
      //     // Additional actions can be performed here after the pulses
      //   }
      // }
